...
loop 
  ...
  ld_indexable(buffer)(float,float,float,float) r15.xyzw, r12.wwww, t2.xyzw
  add r15.xyz, r15.xyzx, -v2.xyzx
  dp3 r13.w, r15.xyzx, r15.xyzx
  sqrt r14.w, r13.w
  lt r16.x, r14.w, r15.w
  if_nz r16.x
    rsq r16.x, r13.w
    mul r16.xyz, r15.xyzx, r16.xxxx
    div r16.w, r14.w, r15.w
    ...
    ld_indexable(buffer)(float,float,float,float) r17.xyz, r12.wwww, t3.xyzw
    dp3_sat r15.w, r16.xyzx, r2.xyzx
    mul r18.xyz, r15.wwww, r17.xyzx
    mul r18.xyz, r13.wwww, r18.xyzx
    mul r18.xyz, r18.xyzx, cb5[1].yyyy
    mul r18.xyz, r18.xyzx, l(10.000000, 10.000000, 10.000000, 0.000000)
    mad r19.xyz, r3.xyzx, r0.zzzz, r15.xyzx
    dp3 r15.w, r19.xyzx, r19.xyzx
    rsq r15.w, r15.w
    mul r19.xyz, r15.wwww, r19.xyzx
    dp3_sat r15.w, r2.xyzx, r15.xyzx
    dp3_sat r16.w, r2.xyzx, r19.xyzx
    dp3_sat r15.x, r15.xyzx, r19.xyzx
    mul r15.y, r16.w, r16.w
    mad r15.y, r15.y, r5.z, l(1.000000)
    mul r15.y, r15.y, r15.y
    mul r15.y, r15.y, l(3.141590)
    div r15.y, r5.y, r15.y
    add r15.x, -r15.x, l(1.000000)
    mul r15.z, r15.x, r15.x
    mul r15.z, r15.z, r15.z
    mul r15.x, r15.z, r15.x
    mad r15.x, r7.x, r15.x, cb5[10].y
    mad r15.z, r15.w, r5.w, r7.y
    div r15.z, l(1.000000, 1.000000, 1.000000, 1.000000), r15.z
    mul r15.z, r5.x, r15.z
    mul r15.y, r15.y, r15.w
    mul r15.x, r15.x, r15.y
    mul r15.x, r15.z, r15.x
    mul r15.xyz, r15.xxxx, r17.xyzx
    mul r15.xyz, r13.wwww, r15.xyzx
    mul r15.xyz, r15.xyzx, l(10.000000, 10.000000, 10.000000, 0.000000)
    dp3_sat r15.w, r16.xyzx, -r2.xyzx
    mul r16.xyz, r15.wwww, r17.xyzx
    mul r16.xyz, r13.wwww, r16.xyzx
    mul r16.xyz, r16.xyzx, cb5[1].yyyy
    mul r16.xyz, r16.xyzx, l(10.000000, 10.000000, 10.000000, 0.000000)
    if_nz cb5[6].z
      mul r17.xyz, r18.xyzx, r15.xyzx
      add r17.xyz, r17.xyzx, r17.xyzx
    else 
      mul r19.xyz, r18.xyzx, r15.xyzx
      mul r17.xyz, r4.xyzx, r19.xyzx
    endif 
  else 
  ...
  mad r15.xyz, r7.zzzz, r15.xyzx, r15.xyzx
  if_nz cb5[8].z
    div r13.w, l(1.000000, 1.000000, 1.000000, 1.000000), r14.w
    mul r13.w, r13.w, l(10.000000)
    mul r14.w, r11.y, r13.w
    mul r19.xyz, r14.wwww, cb5[2].xyzx
    mul r19.xyz, r7.wwww, r19.xyzx
    if_nz r9.x
      mul r20.xyz, r19.xyzx, l(0.066667, 0.066667, 0.066667, 0.000000)
      mul r18.xyz, r18.xyzx, r20.xyzx
      mul r17.xyz, r17.xyzx, r20.xyzx
      mul r16.xyz, r16.xyzx, r20.xyzx
      mul r15.xyz, r15.xyzx, r20.xyzx
    else 
      ld_indexable(buffer)(float,float,float,float) r20.xyz, r12.wwww, t3.xyzw
      mul r12.w, r11.x, r13.w
      mad r19.xyz, r12.wwww, r8.yzwy, r19.xyzx
      mul r12.w, r1.z, r13.w
      mul r21.xyz, r10.wwww, r17.xyzx
      mul r21.xyz, r11.wwww, r21.xyzx
      mul r21.xyz, r21.xyzx, cb5[3].zzzz
      mad r21.xyz, r21.xyzx, r13.wwww, r19.xyzx
      mul r22.xyz, r17.xyzx, r12.wwww
      mad r21.xyz, r22.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r21.xyzx
      mul r21.xyz, r20.xyzx, r21.xyzx
      mul r18.xyz, r18.xyzx, r21.xyzx
      mul r17.xyz, r17.xyzx, r21.xyzx
      mul r21.xyz, r10.wwww, r15.xyzx
      mul r21.xyz, r11.wwww, r21.xyzx
      mul r21.xyz, r21.xyzx, cb5[3].zzzz
      mad r19.xyz, r21.xyzx, r13.wwww, r19.xyzx
      mul r21.xyz, r15.xyzx, r12.wwww
      mad r19.xyz, r21.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r19.xyzx
      mul r19.xyz, r20.xyzx, r19.xyzx
      mul r16.xyz, r16.xyzx, r19.xyzx
      mul r15.xyz, r15.xyzx, r19.xyzx
    endif 
  endif 
  add r9.yzw, r9.yyzw, r18.xxyz
...
loop 
  ...
  ld_indexable(buffer)(float,float,float,float) r18.xyzw, r3.wwww, t5.xyzw
  ld_indexable(buffer)(float,float,float,float) r19.xyzw, r3.wwww, t7.xyzw
  mad r4.w, -r19.x, r19.x, l(1.000000)
  mad r4.w, -r19.y, r19.y, r4.w
  sqrt r4.w, r4.w
  lt r6.w, l(0.000000), r19.z
  movc r20.z, r6.w, r4.w, -r4.w
  mov r20.xy, r19.xyxx
  mad r21.xyz, -r18.wwww, r20.xyzx, r18.xyzx
  add r21.xyz, r21.xyzx, -v2.xyzx
  dp3 r4.w, r21.xyzx, r21.xyzx
  rsq r11.z, r4.w
  mul r22.xyz, r11.zzzz, r21.xyzx
  sqrt r11.z, r4.w
  dp3 r12.w, -r22.xyzx, r20.xyzx
  movc r6.w, r6.w, r19.z, -r19.z
  lt r13.w, r11.z, r19.w
  lt r14.w, r6.w, r12.w
  ...
  if_nz r13.w
    ...
    div r6.w, r12.w, r6.w
    mul r6.w, r6.w, r6.w
    div r11.z, r11.z, r19.w
    mul r11.z, r11.z, r11.z
    mad r11.z, -r11.z, r11.z, l(1.000000)
    mul r11.z, r11.z, r11.z
    min r11.z, r11.z, l(1.000000)
    mul r11.z, r11.z, r19.w
    add r4.w, r4.w, l(1.000000)
    div r4.w, r11.z, r4.w
    ld_indexable(buffer)(float,float,float,float) r19.xyz, r3.wwww, t6.xyzw
    dp3_sat r11.z, r22.xyzx, r2.xyzx
    mul r20.xyz, r11.zzzz, r19.xyzx
    mul r20.xyz, r4.wwww, r20.xyzx
    mul r20.xyz, r6.wwww, r20.xyzx
    mul r20.xyz, r20.xyzx, cb5[1].yyyy
    mul r20.xyz, r20.xyzx, l(10.000000, 10.000000, 10.000000, 0.000000)
    mad r23.xyz, r3.xyzx, r0.zzzz, r21.xyzx
    dp3 r11.z, r23.xyzx, r23.xyzx
    rsq r11.z, r11.z
    mul r23.xyz, r11.zzzz, r23.xyzx
    dp3_sat r11.z, r2.xyzx, r21.xyzx
    dp3_sat r12.w, r2.xyzx, r23.xyzx
    dp3_sat r13.w, r21.xyzx, r23.xyzx
    mul r12.w, r12.w, r12.w
    mad r12.w, r12.w, r5.z, l(1.000000)
    mul r12.w, r12.w, r12.w
    mul r12.w, r12.w, l(3.141590)
    div r12.w, r5.y, r12.w
    add r13.w, -r13.w, l(1.000000)
    mul r14.w, r13.w, r13.w
    mul r14.w, r14.w, r14.w
    mul r13.w, r13.w, r14.w
    mad r13.w, r7.x, r13.w, cb5[10].y
    mad r14.w, r11.z, r5.w, r7.y
    div r14.w, l(1.000000, 1.000000, 1.000000, 1.000000), r14.w
    mul r14.w, r5.x, r14.w
    mul r11.z, r11.z, r12.w
    mul r11.z, r13.w, r11.z
    mul r11.z, r14.w, r11.z
    mul r21.xyz, r11.zzzz, r19.xyzx
    mul r21.xyz, r4.wwww, r21.xyzx
    mul r21.xyz, r6.wwww, r21.xyzx
    ...
    if_nz cb5[6].z
      ...
      mul r23.xyz, r20.xyzx, r21.xyzx
      mul r22.xyz, r4.xyzx, r23.xyzx
    endif 
  else 
  ...
  if_nz cb5[8].z
    ...
    mul r6.w, r4.w, r11.y
    mul r18.xyz, r6.wwww, cb5[2].xyzx
    mul r18.xyz, r7.wwww, r18.xyzx
    if_nz r9.x
      mul r23.xyz, r18.xyzx, l(0.066667, 0.066667, 0.066667, 0.000000)
      mul r20.xyz, r20.xyzx, r23.xyzx
      mul r22.xyz, r22.xyzx, r23.xyzx
      mul r19.xyz, r19.xyzx, r23.xyzx
      mul r21.xyz, r21.xyzx, r23.xyzx
    else 
      ld_indexable(buffer)(float,float,float,float) r23.xyz, r3.wwww, t6.xyzw
      mul r3.w, r4.w, r11.x
      mad r18.xyz, r3.wwww, r8.yzwy, r18.xyzx
      mul r3.w, r1.z, r4.w
      mul r24.xyz, r10.wwww, r22.xyzx
      mul r24.xyz, r11.wwww, r24.xyzx
      mul r24.xyz, r24.xyzx, cb5[3].zzzz
      mad r24.xyz, r24.xyzx, r4.wwww, r18.xyzx
      mul r25.xyz, r22.xyzx, r3.wwww
      mad r24.xyz, r25.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r24.xyzx
      mul r24.xyz, r23.xyzx, r24.xyzx
      mul r20.xyz, r20.xyzx, r24.xyzx
      mul r22.xyz, r22.xyzx, r24.xyzx
      mul r24.xyz, r10.wwww, r21.xyzx
      mul r24.xyz, r11.wwww, r24.xyzx
      mul r24.xyz, r24.xyzx, cb5[3].zzzz
      mad r18.xyz, r24.xyzx, r4.wwww, r18.xyzx
      mul r24.xyz, r21.xyzx, r3.wwww
      mad r18.xyz, r24.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r18.xyzx
      mul r18.xyz, r23.xyzx, r18.xyzx
      mul r19.xyz, r18.xyzx, r19.xyzx
      mul r21.xyz, r18.xyzx, r21.xyzx
    endif 
  endif 
  ...
  iadd r2.w, r2.w, l(1)
endloop 
add r2.yzw, r6.xxyz, r6.xxyz
add r3.xyz, r16.xyzx, r16.xyzx
...
mad r2.xyz, r15.xyzx, l(8.000000, 8.000000, 8.000000, 0.000000), r2.xyzx
mad r3.xyz, r17.xyzx, l(8.000000, 8.000000, 8.000000, 0.000000), r3.xyzx
