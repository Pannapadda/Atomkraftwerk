...
mov r3.zw, l(0,0,0,0)
ld_indexable(texture2d)(float,float,float,float) r1.w, r3.xyww, t4.yzwx
ne r2.w, r1.w, l(0.000000)
if_nz r2.w
  ld_indexable(texture2d)(float,float,float,float) r2.w, r3.xyzw, t3.yzwx
  mad r2.w, r2.w, cb2[15].z, cb2[15].w
  div r2.w, l(1.000000, 1.000000, 1.000000, 1.000000), r2.w
  mad r1.w, r1.w, cb2[15].z, cb2[15].w
  div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r1.w
  atomic_umax g0, l(0), r2.w
  atomic_umin g1, l(0), r1.w
endif 
sync_g_t
