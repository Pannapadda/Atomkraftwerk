...
void VModelPowerLine::placeConduit(void)
{
	...
	m_zgRightConduit3.Init(CHVector(0.49f, 0.005f, 0.005f), &m_zmBlack);
	m_zgRightConduit4.Init(CHVector(0.49f, 0.005f, 0.005f), &m_zmBlack);
	...
	m_zpRightConduit3.RotateYDelta(m_Helper.AngleToRad(14.5f));
	m_zpRightConduit3.TranslateDelta(CHVector(m_zpvPole2.GetX() - 0.465f, m_zvFoundation2.GetY() * 2 + 0.375f + 0.375f + 0.375f + 0.375f + 0.17f, m_zpvPole2.GetZ() - 0.367f));

	m_zpRightConduit4.RotateYDelta(m_Helper.AngleToRad(-14.5f));
	m_zpRightConduit4.TranslateDelta(CHVector(m_zpvPole2.GetX() - 0.465f, m_zvFoundation2.GetY() * 2 + 0.375f + 0.375f + 0.375f + 0.375f + 0.17f, m_zpvPole4.GetZ() + 0.367f));
