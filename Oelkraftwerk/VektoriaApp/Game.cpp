...
void CGame::Init(HWND hwnd, CSplash * psplash)
{
	...
	m_zs.AddPlacement(&m_zpOelkraftwerk);
	m_zpOelkraftwerk.AddPlacement(&m_zpFundament);
	m_zpOelkraftwerk.AddPlacement(&m_zpKamin);
	m_zpOelkraftwerk.AddPlacement(m_zTrasse1);
	m_zpOelkraftwerk.AddPlacement(m_zTrasse2);
	...
	m_zTrasse1->Translate(CHVector(-3.0f, 0.35f, 3.5f));
