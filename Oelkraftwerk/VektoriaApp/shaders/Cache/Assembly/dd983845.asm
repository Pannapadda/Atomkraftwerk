...
mad r1.w, r1.w, cb2[15].z, cb2[15].w
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r1.w
ldms_indexable(texture2dms)(float,float,float,float) r2.w, r3.xyww, t4.yzwx, l(0)
mad r4.w, r2.w, cb2[15].z, cb2[15].w
div r4.w, l(1.000000, 1.000000, 1.000000, 1.000000), r4.w
ne r2.w, r2.w, l(0.000000)
max r5.y, r1.w, l(0.000000)
min r5.x, r4.w, l(340282346638528860000000000000000000000.000000)
movc r5.xy, r2.wwww, r5.xyxx, l(340282346638528860000000000000000000000.000000,0,0,0)
ldms_indexable(texture2dms)(float,float,float,float) r1.w, r3.xyww, t3.yzwx, l(1)
mad r1.w, r1.w, cb2[15].z, cb2[15].w
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r1.w
ldms_indexable(texture2dms)(float,float,float,float) r2.w, r3.xyzw, t4.yzwx, l(1)
mad r3.x, r2.w, cb2[15].z, cb2[15].w
div r3.x, l(1.000000, 1.000000, 1.000000, 1.000000), r3.x
ne r2.w, r2.w, l(0.000000)
max r6.y, r1.w, r5.y
min r6.x, r3.x, r5.x
movc r3.xy, r2.wwww, r6.xyxx, r5.xyxx
atomic_umax g0, l(0), r3.y
atomic_umin g1, l(0), r3.x
sync_g_t
...
if_z r0.x
  ...
  imad r1.xyz, cb2[24].yyyy, r0.yyyy, l(1, 2, 3, 0)
  store_uav_typed u1.xyzw, r1.xxxx, r0.wwww
  ld_raw r0.x, l(0), g5.xxxx
  store_uav_typed u1.xyzw, r1.yyyy, r0.xxxx
  ld_raw r0.x, l(0), g6.xxxx
  iadd r0.x, r0.x, l(-272)
  store_uav_typed u1.xyzw, r1.zzzz, r0.xxxx
endif 
ret 
