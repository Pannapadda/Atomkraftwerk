...
loop 
  uge r2.w, r1.w, l(4)
  breakc_nz r2.w
  ldms_indexable(texture2dms)(float,float,float,float) r2.w, r3.xyww, t3.yzwx, r1.w
  mad r2.w, r2.w, cb2[15].z, cb2[15].w
  div r2.w, l(1.000000, 1.000000, 1.000000, 1.000000), r2.w
  ldms_indexable(texture2dms)(float,float,float,float) r4.w, r3.xyzw, t4.yzwx, r1.w
  mad r6.x, r4.w, cb2[15].z, cb2[15].w
  div r6.x, l(1.000000, 1.000000, 1.000000, 1.000000), r6.x
  ne r4.w, r4.w, l(0.000000)
  max r7.y, r2.w, r5.w
  min r7.x, r5.z, r6.x
  movc r5.zw, r4.wwww, r7.xxxy, r5.zzzw
  iadd r1.w, r1.w, l(1)
endloop 
