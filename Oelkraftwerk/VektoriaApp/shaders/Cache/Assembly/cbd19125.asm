...
loop 
  ...
  if_nz r20.x
    rsq r20.x, r17.w
    mul r20.xyzw, r19.yzxz, r20.xxxx
    ...
    dp3_sat r18.w, r20.zxwz, r5.xzwx
    mul r22.xyz, r18.wwww, r21.xyzx
    mul r22.xyz, r17.wwww, r22.xyzx
    mul r22.xyz, r22.xyzx, cb5[1].yyyy
    mad r23.xyz, r3.xyzx, r0.zzzz, r19.xyzx
    dp3 r18.w, r23.xyzx, r23.xyzx
    rsq r18.w, r18.w
    mul r23.xyz, r18.wwww, r23.xyzx
    dp3_sat r18.w, r9.xyzx, r19.xyzx
    dp3_sat r21.w, r9.xyzx, r23.xyzx
    dp3_sat r19.x, r19.xyzx, r23.xyzx
    mul r19.y, r21.w, r21.w
    ...
    if_nz cb5[6].z
      mul r21.xyz, r22.xyzx, r19.xyzx
      add r21.xyz, r21.xyzx, r21.xyzx
    else 
      mul r19.xyz, r22.xyzx, r19.xyzx
      mul r21.xyz, r12.xyzx, r19.xyzx
    endif 
    lt r23.xyzw, |r20.xyzw|, |r20.zzxx|
    ge r19.xy, -r20.zxzz, l(0.000000, 0.000000, 0.000000, 0.000000)
    and r20.xy, r23.ywyy, r23.xzxx
    movc r19.xy, r19.xyxx, l(0,2,0,0), l(1,3,0,0)
    ge r17.w, r20.w, l(0.000000)
    movc r17.w, r17.w, l(4), l(5)
    movc r17.w, r20.y, r19.y, r17.w
    movc r17.w, r20.x, r19.x, r17.w
    ishl r18.w, r17.w, l(2)
    imad r18.w, r13.x, l(24), r18.w
    dp4 r19.x, r1.xyzw, cb3[r18.w + 0].xyzw
    dp4 r19.y, r1.xyzw, cb3[r18.w + 1].xyzw
    dp4 r19.z, r1.xyzw, cb3[r18.w + 2].xyzw
    dp4 r18.w, r1.xyzw, cb3[r18.w + 3].xyzw
    ...
    mul r20.x, r17.w, l(0.166667)
    utof r17.w, r13.x
    add r17.w, r17.w, r19.y
    mul r20.y, r17.w, l(0.083333)
    mul_sat r17.w, r19.w, l(5.000000)
    mad r17.w, r17.w, l(-9.900000), l(10.000000)
    mad r17.w, -r17.w, cb3[336].w, r19.z
    sample_c_lz_indexable(-3,-3,0)(texture2d)(float,float,float,float) r18.w, r20.xyxx, t13.xxxx, s1, r17.w
    sample_c_lz_indexable(-3,-2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-3,-1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-3,0,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-3,1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-3,2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-3,3,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-2,-3,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-2,-2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-2,-1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-2,0,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-2,1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-2,2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    ...
    sample_c_lz_indexable(-2,3,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-1,-3,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-1,-2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-1,-1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-1,0,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-1,1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(-1,2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    ...
    sample_c_lz_indexable(-1,3,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(0,-3,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(0,-2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(0,-1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(0,0,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(0,1,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(0,2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    ...
    sample_c_lz_indexable(3,2,0)(texture2d)(float,float,float,float) r19.x, r20.xyxx, t13.xxxx, s1, r17.w
    add r18.w, r18.w, r19.x
    sample_c_lz_indexable(3,3,0)(texture2d)(float,float,float,float) r17.w, r20.xyxx, t13.xxxx, s1, r17.w
    add r17.w, r17.w, r18.w
    mul r17.w, r17.w, l(0.020408)
    mul r19.xyz, r17.wwww, r22.xyzx
    mul r20.xyz, r17.wwww, r21.xyzx
    mul r19.xyz, r19.xyzx, l(16.000000, 16.000000, 16.000000, 0.000000)
...
endloop 
ld_indexable(buffer)(uint,uint,uint,uint) r0.w, r3.wwww, t8.yzwx
ld_indexable(buffer)(uint,uint,uint,uint) r1.w, r8.xxxx, t8.yzwx
ishl r0.w, r0.w, l(16)
or r0.w, r1.w, r0.w
lt r0.w, r4.w, r0.w
movc r1.w, r0.w, r8.y, r5.y
...
loop 
  ...
  ld_indexable(buffer)(float,float,float,float) r18.xyzw, r5.yyyy, t5.xyzw
  ld_indexable(buffer)(float,float,float,float) r19.xyzw, r5.yyyy, t7.xyzw
  mad r9.w, -r19.x, r19.x, l(1.000000)
  mad r9.w, -r19.y, r19.y, r9.w
  sqrt r9.w, r9.w
  lt r11.w, l(0.000000), r19.z
  movc r20.z, r11.w, r9.w, -r9.w
  mov r20.xy, r19.xyxx
  mad r21.xyz, -r18.wwww, r20.xyzx, r18.xyzx
  add r21.xyz, -r1.xyzx, r21.xyzx
  dp3 r9.w, r21.xyzx, r21.xyzx
  rsq r13.x, r9.w
  mul r22.xyz, r13.xxxx, r21.xyzx
  sqrt r13.x, r9.w
  dp3 r16.w, -r22.xyzx, r20.xyzx
  movc r11.w, r11.w, r19.z, -r19.z
  lt r17.w, r13.x, r19.w
  lt r18.w, r11.w, r16.w
  and r17.w, r17.w, r18.w
  if_nz r17.w
    ...
    div r13.x, r13.x, r19.w
    mul r13.x, r13.x, r13.x
    mad r13.x, -r13.x, r13.x, l(1.000000)
    mul r13.x, r13.x, r13.x
    min r13.x, r13.x, l(1.000000)
    mul r13.x, r13.x, r19.w
    add r9.w, r9.w, l(1.000000)
    div r9.w, r13.x, r9.w
    ld_indexable(buffer)(float,float,float,float) r19.xyz, r5.yyyy, t6.xyzw
    dp3_sat r13.x, r22.xyzx, r5.xzwx
    mul r20.xyz, r13.xxxx, r19.xyzx
    ...
    dp3 r13.x, r22.xyzx, r22.xyzx
    rsq r13.x, r13.x
    mul r22.xyz, r13.xxxx, r22.xyzx
    dp3_sat r13.x, r9.xyzx, r21.xyzx
    dp3_sat r16.w, r9.xyzx, r22.xyzx
    dp3_sat r17.w, r21.xyzx, r22.xyzx
    mul r16.w, r16.w, r16.w
    mad r16.w, r16.w, r10.y, l(1.000000)
    mul r16.w, r16.w, r16.w
    mul r16.w, r16.w, l(3.141590)
    div r16.w, r10.x, r16.w
    add r17.w, -r17.w, l(1.000000)
    mul r18.w, r17.w, r17.w
    mul r18.w, r18.w, r18.w
    mul r17.w, r17.w, r18.w
    mad r17.w, r10.z, r17.w, cb5[10].y
    mad r18.w, r13.x, r7.w, r10.w
    div r18.w, l(1.000000, 1.000000, 1.000000, 1.000000), r18.w
    mul r18.w, r3.w, r18.w
    mul r13.x, r13.x, r16.w
    mul r13.x, r17.w, r13.x
    mul r13.x, r18.w, r13.x
    mul r19.xyz, r13.xxxx, r19.xyzx
    ...
    if_nz cb5[6].z
      ...
      mul r21.xyz, r4.xyzx, r19.xyzx
    endif 
    ishl r9.w, r5.y, l(2)
    dp4 r19.x, r6.xyzw, cb3[r9.w + 288].xyzw
    dp4 r19.y, r6.xyzw, cb3[r9.w + 289].xyzw
    dp4 r19.z, r6.xyzw, cb3[r9.w + 290].xyzw
    dp4 r9.w, r6.xyzw, cb3[r9.w + 291].xyzw
    div r19.xyz, r19.xyzx, r9.wwww
    mad r22.yz, r19.xxyx, l(0.000000, 0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
    utof r9.w, r5.y
    add r9.w, r9.w, r22.y
    mul r22.x, r9.w, l(0.083333)
    mad r9.w, -cb3[336].w, l(6.000000), r19.z
    sample_c_lz_indexable(-3,-3,0)(texture2d)(float,float,float,float) r11.w, r22.xzxx, t14.xxxx, s1, r9.w
    sample_c_lz_indexable(-3,-2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-3,-1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-3,0,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-3,1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-3,2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-3,3,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-2,-3,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-2,-2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-2,-1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-2,0,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-2,1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-2,2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    ...
    sample_c_lz_indexable(-2,3,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-1,-3,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-1,-2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-1,-1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-1,0,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-1,1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(-1,2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    ...
    sample_c_lz_indexable(-1,3,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(0,-3,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(0,-2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(0,-1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(0,0,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(0,1,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(0,2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    ...
    sample_c_lz_indexable(3,2,0)(texture2d)(float,float,float,float) r13.x, r22.xzxx, t14.xxxx, s1, r9.w
    add r11.w, r11.w, r13.x
    sample_c_lz_indexable(3,3,0)(texture2d)(float,float,float,float) r9.w, r22.xzxx, t14.xxxx, s1, r9.w
    add r9.w, r9.w, r11.w
    mul r9.w, r9.w, l(0.020408)
    mul r19.xyz, r9.wwww, r20.xyzx
    mul r20.xyz, r9.wwww, r21.xyzx
    mul r19.xyz, r19.xyzx, l(16.000000, 16.000000, 16.000000, 0.000000)
    mul r20.xyz, r20.xyzx, l(16.000000, 16.000000, 16.000000, 0.000000)
  else 
    mov r19.xyz, l(0,0,0,0)
  ...
  if_nz cb5[8].z
    ...
    if_nz r11.z
      ...
      ld_indexable(buffer)(float,float,float,float) r21.xyz, r5.yyyy, t6.xyzw
      mul r5.y, r8.x, r14.y
      mul r22.xyz, r14.xxxx, r20.xyzx
      mul r22.xyz, r15.xxxx, r22.xyzx
      mad r18.xyz, r5.yyyy, r2.xyzx, r18.xyzx
      mul r22.xyz, r22.xyzx, cb5[3].zzzz
      mad r18.xyz, r22.xyzx, r8.xxxx, r18.xyzx
      mul r5.y, r8.x, r11.y
      mul r8.xyz, r20.xyzx, r5.yyyy
      mad r8.xyz, r8.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r18.xyzx
      mul r8.xyz, r21.xyzx, r8.xyzx
...
mad r3.xyz, r12.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), r3.xyzx
...
ret 
// Approximately 888 instruction slots used
